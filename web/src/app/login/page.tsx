    ...
    <section className="flex-grow flex items-center justify-center px-6 py-12 z-10 relative min-h-[calc(100vh-64px)]">
      ...
      <div className="glass-panel w-full max-w-md rounded-xl p-8 flex flex-col gap-6 relative z-10">
        ...
        <div className="flex flex-col gap-3">
          <a href="/api/auth/google" className="w-full bg-surface-container-highest hover:bg-surface-bright transition-colors border border-outline-glass rounded-lg py-2.5 px-4 flex items-center justify-center gap-2 text-sm text-on-surface h-11">
